...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
            {"Upsire-D3 100IU Capsule","","","","50"},
            {"HealthVit Chromium Picolinate 200","","","","305"},
            {"Vitamin B Complex Capsules","","","","305"},
            {"Tata ing Calcium Vitamin D3","","","","400"},
            {"Inlife Vitamin E Wheat Germ Oil Capsule","","","","765"},
            {"Dolo 650 Tablet","","","","509"},
            {"Crocin 650 Advance Tablet","","","","995"},
            {"Strepsils Medicated Lozenges for Sore Throat","","","","380"},
            {"Feronia -XT Tablet","","","","105"},
    };
